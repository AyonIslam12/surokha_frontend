<template>
  <div>
    <div class="my-16 text-left">
      <h2 class="mb-6 text-4xl font-bold">3 Steps</h2>
      <p class="text-lg">of receiving the Covid-19 vaccine</p>
    </div>

    <div class="flex mb-20 text-lg">
      <div class="w-1/3 pr-16">
        <div class="flex items-center h-32 mb-8">
          <img src="~/static/img/steps-1.svg" alt="">
        </div>
        <h3 class="mb-6 text-2xl font-bold">Online Registration</h3>
      ...
      <div class="w-1/3 px-8">
        <div class="flex items-center h-32 mb-8">
          <img src="~/static/img/steps-2.svg" alt="">
        </div>
        <h3 class="mb-6 text-2xl font-bold">SMS Notification</h3>
      ...
      <div class="w-1/3 pl-16">
        <div class="flex items-center h-32 mb-8">
          <img src="~/static/img/steps-3.svg" alt="">
        </div>
        <h3 class="mb-6 text-2xl font-bold">Vaccination</h3>
